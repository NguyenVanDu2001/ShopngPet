...
namespace ShopThoiTrang.nganluonAPI
{
    public class nganluongInfo
    {
        ...
        public static readonly string return_url = "http://localhost:64861/confirm-orderPaymentOnline";
        // dường dẫn khi thanh tán thất bại
        public static readonly string cancel_url = "http://localhost:64861/cancel-order";
